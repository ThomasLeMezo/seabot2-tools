...
class DockImu(Seabot2Dock):
    def __init__(self, seabot2_bag, tabWidget):
        ...
        print("DockIMU initialized")

    def add_imu(self):
        dock_imu = Dock("IMU RAW")
        self.addDock(dock_imu, position='below')
        data = self.s2b.imu_raw_data
        data_debug = self.s2b.imu_fusion_debug
    ...
    def calibrate_mag(self):
        ...
        data_raw_mag = self.s2b.imu_raw_data
    ...
    def add_imu_calibrated(self):
        ...
        self.addDock(dock_imu, position='below')
        data = self.s2b.imu_calibrated_data
